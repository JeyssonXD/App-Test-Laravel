...
@section('Breadcumbs')
  @include('../share/Breadcumbs' , [ 'Links' => array(
                                            ...
                                            "typeProductCreate"=>array("Title"=>"New","Link"=>Route('typeProductCreate'),"Active"=>true)
                                      )])
@endsection
...
<div class="container">
  <div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card">
            <form action="{{ route('typeProductStore') }}" method="POST">
            @csrf 
            <h5 class="card-header">New Type Product</h5>
            <div class="card-body">
                <div class="form-row">
